    ...
    <>
      ...
      <header className="sticky top-0 z-40 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
        <div className="flex items-center justify-between h-14 px-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700"
        ...
        <div className="border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/50">
          <div className="flex items-center justify-between h-12 px-4 max-w-7xl mx-auto">
            <div className="flex items-center gap-2">
              {appIcon}
              <h1 className="font-display font-semibold text-lg text-neutral-900 dark:text-neutral-100">
                {appTitle}
              </h1>
            </div>
            {rightContent && (
      ...
      {isSidebarOpen && (
        <>
          ...
          />
          <aside className="fixed top-0 left-0 z-40 h-full w-72 bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 shadow-xl">
